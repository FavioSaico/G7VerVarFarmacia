            ...
            <div class="input-states">
              <form class="form-horizontal needs-validation" method="POST" id="createOrderForm" action="php_action/order.php" novalidate>
                ...
                <table class="table" id="productTable">
                  <thead>
                    <tr>
                      <th style="width:30%;">Medicina</th>
                      <th style="width:12%;">Disponibles</th>
                      <th style="width:12%;">Cantidad por unidad</th>
                    ...
                    for ($x = 1; $x < 2; $x++) { ?>
                      <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                        ...
                        <td style="padding-left:20px;">
                          ...
                          <input type="hidden" name="rateValue[]" id="rateValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $cantUnidad?>" />
                        </td>
                        <td style="padding-left:20px;">
                          <!-- Precio -->
                          <input type="text" name="price[]" id="price<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" /> 
                          <input type="hidden" name="priceValue[]" id="priceValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $precio?>" />
                        </td>
                        <td style="padding-left:20px;">
                          <!-- Cantidad a comprar-->
                          <div class="form-group">
